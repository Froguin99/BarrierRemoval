# Uncomment the pip install for the first run of this notebook
...
#%%
bike_graph = ox.graph_from_place('Newcastle Upon Tyne, United Kingdom', network_type="bike")



#%%
edges = ox.graph_to_gdfs(ox.get_undirected(bike_graph), nodes=False, edges=True, node_geometry=False, fill_edge_geometry=True)
ox.save_graph_geopackage(bike_graph, filepath=(r'C:\Users\b8008458\Documents\2021_2022\Scratch Space\BikeNetwork\bike_network.gpkg'))
...
ax.set_axis_off()
ax.set_title('betweenness edge based')
plt.show()
#%%

# bike_graph_bc = nx.edge_betweenness_centrality(bike_graph)

#%%

# ox.save_graph_geopackage(bike_graph_bc, filepath=(r'C:\Users\b8008458\Documents\2021_2022\Scratch Space\BikeNetwork\bike_network_bc.gpkg'))
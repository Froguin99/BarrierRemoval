...
#define CONFIGURE_ARGS "--enable-thread-safety --with-ldap --with-ssl=openssl --with-libxml --with-libxslt --with-gssapi"
...
#define PG_VERSION_STR "PostgreSQL 14.2, compiled by Visual C++ build " CppAsString2(_MSC_VER) ", 64-bit"
